...
const Nav = () => {
  ...
  return (
    <div>
     ...
     {
      nav ? (
       <div className="fixed w-full h-screen bg-white/90 flex dlex-col justify-center items-center z-20">
     ...
     <div className='md:block hidden fixed top-[25%] z-10'>
      <div className="flex flex-col">
        ...
        <a href ="work" className="rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duartion-300">
          <GrProjects size={20}/>
        </a>
        <a href ="#project" className="rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duartion-300">
          <AiOutlineProject size={20}/>
        </a>
        <a href ="#main" className="rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duartion-300">
          <BsPerson size={20}/>
